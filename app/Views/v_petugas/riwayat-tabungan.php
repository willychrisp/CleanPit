    ...
    <div class="card">
        ...
        <div class="card-body  pl-4">
            ...
            <div>
                ...
                <hr>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="filter-tarik" placeholder="Filter Penarikan" name="filter-tarik">

                    <input type="text" class="form-control" id="filter-setor" placeholder="Filter Setor Sampah" name="filter-setor">
                </div>
...
<script>
    ...
    function ambilPenarikan() {
        $.ajax({
            type: 'POST',
            url: '<?php base_url() ?>/TabunganController/ambilData',
            dataType: 'json',
            data: {
                jenis: 1
            },
            success: function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    baris += '<div class="container">' +
                        '<p class="login-card-description">Riwayat penarikan uang oleh nasabah</p>' +
                        '<div class="card">' +
                        '<div class="card-body">' +
