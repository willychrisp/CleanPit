    ...
    <div class="row gutters-sm">
            ...
            <div class="card mt-3">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <?php } else { ?>
                            <span class="text-secondary"><?= $komunitas['nama_komunitas'] ?></span>
                        <?php } ?>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <p class="login-card-description">Data diri volunteer</p>
                    <div class="row">
                        <div class="col-sm-3">
            ...
            <?php if ($volunteer['id_pengguna'] == session()->get('id')) { ?>
                <p class="login-card-description" href="/lapor"><a href="/laporan-terkirim"><span style="color: black;"> Laporan Terkirim </span></a></p>
            <?php } else { ?>
                <p class="login-card-description" href="/lapor"><a href="/kiriman-laporan/<?= $volunteer['id_pengguna'] ?>"><span style="color: black;"> Laporan Terkirim </span></a></p>
            <?php } ?>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body" id="lapor">
                                ...
                                <div>
                                    <img id="laporimg<?php echo $lapor['id']; ?>" style="object-fit:cover" max-width="680" width="100%" height="100" src="<?= base_url() ?>/img/<?= $lapor['foto']; ?>" data-toggle="modal" data-target="#myModal<?php echo $lapor['id']; ?>">
