    ...
    <div class="card login-card">
        <?php if (empty($komunitas)) { ?>
            <div class="row justify-content-md-center text-center mb-5">
                <div class="col-lg-7">
                    <h2 class="mt-10 heading-border-top login-card-description">Anda sedang tidak tergabung dengan komunitas manapun</h2>
                    <p><a href="/komunitas" role="button" class="btn smoothscroll pb_outline-dark p-3 rounded-0 pb_font-13 pb_letter-spacing-2">Cari Komunitas</a></p>
                </div>
        <?php } else { ?>
