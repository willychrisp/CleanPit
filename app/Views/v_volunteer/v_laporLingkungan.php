<div class="container" style="padding-top: 100px;">
    ...
    <div class="card login-card">
        <div class="card-body pt-4 pl-4 pb-4">
            ...
            <form action="/LaporanController/kirimlaporan" id="formLapor" method="POST" enctype="multipart/form-data" style="padding-left: 50px;" onsubmit="validateForm(event)">
                ...
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control" placeholder="Tanggal Kegiatan" value="<?= date("d / M / Y") ?>">
                </div>
                <div class="form-group">
        ...
        <div class="form-group">
            <input class="btn btn-block login-btn mb-4" id="jenis" name="jenis" value="1" type="hidden">
        ...
        <script type="text/javascript">
            function validateForm(e) {
                ...
                if (nama == "" || isi == "" || tanggal == "" || lokasi == "" || foto == "" || wilayah == "" || objek == "") {
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'Nama laporan setidaknya berisi 10 karakter',
                    });
                    return false;
